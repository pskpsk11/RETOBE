...
<div class="container">
	<div class="member_sub">
		...
		<div id="total"> 
			<p><span><strong>총 ${map.count }개</strong>  |  ${courseVO.page }/${map.totalPage }페이지</span></p>
	  	</div>
         <table class="tablea">
	         <thead >
	         	<th><span >
	      	 		<input type="checkbox" name="checkAll" class="check_all" onclick="courseAllSelect(this);" style="text-align:center;">
