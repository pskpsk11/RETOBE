	  ...
	  <div id="con">
		   <div id="boxa">
	         <div id="a">
	            ...
	            <a href="/tobe/gmanager/member.do" id="aa"><font size=1px;>회원관리→ </font></a>
	         ...
	         <div id="b">
	            <a href="/tobe/gmanager/pay.do" id="cc"><font size=1px; style="margin-left:-40px;">결제관리→ </font></a>
	             <div>
	             	<div id="today">
	         ...
	         <div id="a">
	            <a href="/tobe/gmanager/email.do" id="dd"><font size=1px;>이메일→ </font></a>
	            <img src="/tobe/img/mail.png" onclick="location.href='/tobe/gmanager/email.do';" id="mail"><br>
	            <a href="/tobe/gmanager/email.do" id="mailp">메일작성 바로가기</a>
	         </div>
	      </div>
	      <div id="boxa">
	         <div id="a">
	            <a href="/tobe/gmanager/course.do" id="aa"><font size=1px;>강좌관리→ </font></a>
	            <div>
	               <div id="class1">
	                  <img src="/tobe/img/cl_1.png" width=22% height=80%;><p>  강좌  리스트</p><a href="/tobe/gmanager/course.do" id="w1">→</a>
	               </div>
	               <div id="class2">
	                  <img src="/tobe/img/cl_2.png" width=21% height=80%;><p>  강좌 등록하기</p><a href="/tobe/gmanager/courseForm.do" id="w2">→</a>
	               </div>
	            </div>
	         </div>
	         <div id="b">
	            <a href="/tobe/gmanager/customer.do" id="bb"><font size=1px;>고객센터관리→ </font></a>
					...
					<c:forEach var="vo" items="${q}">
						<tr>
							...
							<td class="url" style="width: 40%; cursor:pointer;"
								onclick="location.href='/tobe/gmanager/qnaList.do?qna_no=${vo.qna_no}'">${vo.q_title}</td>    
	         ...
	         <div id="a">
	            <a href="/tobe/gmanager/sales.do" id="aa"><font size=1px;>정산관리→ </font></a>
