			...
			<div class="flex">
				<div class="child">
					...
					<div class="text_s">
						...
						<div class="sub_co">
							${map.cosComp1.cname} <br><br>
							${CodeToString.educationToString(map.cosComp1.education)}<br><br>
							${CodeToString.dateToStirng(map.cosComp1.mon, map.cosComp1.tue, map.cosComp1.wed, map.cosComp1.thu, map.cosComp1.fri, map.cosComp1.sat, map.cosComp1.sun)}<br><br>
							${map.cosComp1.time}<br><br>
							${map.cosComp1.price}원<br><br>
							${map.cosComp1.teacher1} , ${map.cosComp1.teacher2}<br><br>
							${map.cosComp1.startday}<br><br>
							${map.cosComp1.endday}<br><br>
							${map.cosComp1.course_rating}<br><br>
							${map.cosCompRe1}<br><br>
						</div>	
				...
				<div class="child">
					...
					<div class="text_s">
						...
						<div  class="sub_co">
							...
							${CodeToString.educationToString(map.cosComp2.education)}<br><br>
							${CodeToString.dateToStirng(map.cosComp2.mon, map.cosComp2.tue, map.cosComp2.wed, map.cosComp2.thu, map.cosComp2.fri, map.cosComp2.sat, map.cosComp2.sun)}<br><br>
							${map.cosComp2.time}<br><br>
							${map.cosComp2.price}<br><br>
							${map.cosComp2.teacher1} , ${map.cosComp2.teacher2}<br><br>
							${map.cosComp2.startday}<br><br>
							${map.cosComp2.endday}<br><br>
							${map.cosComp2.course_rating}<br><br>
							${map.cosCompRe2}<br><br>
						</div>	
					</div>
				</div>
			</div>	 	
